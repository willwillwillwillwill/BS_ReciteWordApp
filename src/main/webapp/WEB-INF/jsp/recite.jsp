...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        <h3>${word.getWs().getNote()}</h3>
       
      </div>
      <p>
       
        <a  role="button" class="btn btn-lg btn-success" href="http://localhost:9999/ReciteWebApp/recite?order=${word.getOrder()}&num=${word.getNum()+1}&know=1">认识</a>
        </p>
        <p>
        <a role="button" class="btn btn-lg btn-danger"href="http://localhost:9999/ReciteWebApp/recite?order=${word.getOrder()}&num=${word.getNum()+1}&know=0">不认识</a>
        </p>
        <p>
        <a role="button" class="btn btn-lg btn-info"href="http://localhost:9999/ReciteWebApp/recite?order=${word.getOrder()}&num=${word.getNum()}&know=2">添加到单词本</a>
        </p>
