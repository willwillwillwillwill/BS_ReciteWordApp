...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav">
            <li class="active"><a href="http://localhost:9999/ReciteWebApp/userHomePage">Home</a></li>
            <li><a href="http://localhost:9999/ReciteWebApp/reciteBegin">Word</a></li>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        <h1>Summertime is always the best of what might be.</h1>
        <p>— Charles Bowden </p>
      </div>
      ...
      <p>
        ...
        <a  class="btn btn-lg btn-primary" href="http://localhost:9999/ReciteWebApp/recite?order=1&num=-1" role="button" >四级</a>
        </p>
        <p>
        <a class="btn btn-lg btn-success"  href="http://localhost:9999/ReciteWebApp/recite?order=2&num=-1" role="button">六级</a>
        </p>
        <p>
        <a class="btn btn-lg btn-info" href="http://localhost:9999/ReciteWebApp/recite?order=3&num=-1" role="button">考研</a>
