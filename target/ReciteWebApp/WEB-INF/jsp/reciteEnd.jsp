...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li ><a href="https://getbootstrap.com/docs/3.3/examples/theme/#">Home</a></li>
            <li class="active"><a href="https://getbootstrap.com/docs/3.3/examples/theme/#about">Word</a></li>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <h2>恭喜你，完成了本次的背诵任务<h2>
      <p>

        <a  role="button" class="btn btn-lg btn-warning" href="http://localhost:9999/ReciteWebApp/reciteBegin">完成</a>
